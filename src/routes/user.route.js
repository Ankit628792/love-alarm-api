...
const { updateLocation, updateProfile, updateImage, updateSetting, getProfile, paymentIntent, userFeedback, userMatches, getPlan } = require("../controller/user.controller");
